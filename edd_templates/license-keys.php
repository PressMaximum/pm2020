				...
				<tr class="edd_sl_license_row">
									...
									<li class="edd-sl-child">
										<span>
											...
											if ( ! edd_software_licensing()->force_increase() ) {
												$url = esc_url( add_query_arg( array( 'license_id' => $child_key->ID, 'action' => 'manage_licenses', 'payment_id' => $payment_id ), get_permalink( ) ) );
												?>
					...
					<td>
						...
						<?php if( ! edd_software_licensing()->force_increase() && 'expired' !== edd_software_licensing()->get_license_status( $license->ID ) && get_post_status( $license->ID ) !== 'draft' ) : ?>
							<br/><a href="<?php echo esc_url( add_query_arg( array( 'license_id' => $license->ID, 'action' => 'manage_licenses', 'payment_id' => $payment_id ), get_permalink( ) ) ); ?>"><?php _e( 'Manage Sites', 'edd_sl' ); ?></a>
						...
						<?php if( edd_sl_license_has_upgrades( $license->ID ) && 'expired' !== edd_software_licensing()->get_license_status( $license->ID ) ) : ?>
							...
							<a href="<?php echo esc_url( add_query_arg( array( 'view' => 'upgrades', 'license_id' => $license->ID, 'action' => 'manage_licenses', 'payment_id' => $payment_id ), get_permalink( ) ) ); ?>"><?php _e( 'View Upgrades', 'edd_sl' ); ?></a>
